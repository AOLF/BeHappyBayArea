...
function DisplayEvents(data) {
    ...
    $.each(data, function () {
        ...
        strbuilder = '<tr style="color: #333; font-family: Arial, Helvetica, Sans-serif; font-size: 13px;"><td style="padding: 6px; border-bottom: 1px solid #333;">' + this.event.title+'</br>'+
'<span style="font-weight:bold">'+this.event.dt + 
                  
                  '</td><td style="padding: 6px; border-bottom: 1px solid #333;">' + '<span style="font-weight:bold">'+this.event.city+'</span><br/>'
+ this.event.location + '<br/>' + this.event.address + '<br/>' + this.event.city + ', ' + this.event.state + ' ' + this.event.zip_code + 
